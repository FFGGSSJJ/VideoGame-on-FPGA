...
module lab7_soc_mm_interconnect_0 (
	...
	wire    [8:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> sdram_s1_agent:cp_channel
	...
	wire  [106:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> Switches_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                              // Switches_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [8:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> Switches_s1_agent:cp_channel
	...
	wire  [106:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> accumulate_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // accumulate_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [8:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> accumulate_s1_agent:cp_channel
	...
	wire    [8:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> accumulator_reset_s1_agent:cp_channel
	...
	wire  [106:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> led_s1_agent:cp_data
	wire          cmd_mux_008_src_ready;                                                              // led_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire    [8:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> led_s1_agent:cp_channel
	...
	wire  [106:0] switches_s1_agent_rp_data;                                                          // Switches_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [106:0] accumulate_s1_agent_rp_data;                                                        // accumulate_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [106:0] led_s1_agent_rp_data;                                                               // led_s1_agent:rp_data -> router_010:sink_data
	...
	wire    [8:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> cmd_mux_004:sink1_channel
	...
	wire    [8:0] rsp_demux_004_src0_channel;                                                         // rsp_demux_004:src0_channel -> crosser_002:in_channel
	...
	wire    [8:0] crosser_002_out_channel;                                                            // crosser_002:out_channel -> rsp_mux:sink4_channel
	...
	wire    [8:0] rsp_demux_004_src1_channel;                                                         // rsp_demux_004:src1_channel -> crosser_003:in_channel
